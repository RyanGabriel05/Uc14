...
namespace ChapterFST1.Repositories
{
    public class LivroRepository
    {
        ...
        public void Atualizar(int id, Livro livro)
        {
            ...
            _context.Livros.Update(livroBuscado); // dispara uma exception se o livroBuscado for nulo?
        ...
        public void Deletar(int id)
        {
            ...
            _context.Livros.Remove(livro); // dispara uma exception se o livro for nulo?
